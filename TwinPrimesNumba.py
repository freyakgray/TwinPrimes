...
@jit()
def InitializeArraysNumba(size):
    """ 
        Description
        -----------
...
@jit(fastmath = True)
def GenerateHexasNumba(hexasNum):
    """ 
        Description
        -----------
    ...
    hexasArray, sextandsArray, squareSextandsArray = InitializeArraysNumba(hexasNum)
...
@jit(fastmath = True)
def FindInvalidChainsNumba(hexasNum):  
    """ 
        Description
        -----------
    ...
    hexasArray, sextandsArray , squareSextandsArray = GenerateHexasNumba(hexasNum)
...
@jit(fastmath = True)
def GenerateComboNumba(hexasNum, index):
    """ 
        Description
        -----------
    ...
    hexasArray, sextandsArray, squareSextandsArray = GenerateHexasNumba(hexasNum + 1)
...
@jit(fastmath = True)
def ViewComboNumba(hexasNum, start, length):
    """ 
        Description
        -----------
    ...
    for i in range(start,end):
        combo = str(i) + ": "
        combo += GenerateComboNumba(hexasNum, i)
        combosList.insert(i, combo)
    combosArray = np.array(combosList)
    return combosArray

@jit(fastmath = True)
def ViewCritCombosNumba(hexasNum):
    ...
    combosArray = ViewComboNumba(hexasNum, start, length)
    return combosArray

@jit(fastmath = True)
def FindAverageGapNumba(hexasNum):
    """ 
        Description
        -----------
...
@jit(fastmath = True)
def ValidCoordinatesNumba(hexasNum):
    """ 
        Description
        -----------
    ...
    for i in range(2, hexasNum + 1): # Cycle through all hexa pairs
        ...
        writeValidCoordinatesNumba(hexasNum, coor_list)

    return coor_list

def writeValidCoordinatesNumba(hexasNum, coor_list):
    """ 
        Description
        -----------
...
@jit(fastmath = True)
def GenerateCombosNumba(combosNum):
    """ 
        Description
        -----------
    ...
    combosList = []
    hexasArray, sextandsArray, squareSextands_array = GenerateHexasNumba(combosNum)
...
@jit(fastmath = True)
def ValidNumApproximationNumba(hexasNum):
